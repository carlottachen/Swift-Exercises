...
let noun = "puppy"
let place = "mall"
let positiveEmo = "happy"
let negativeEmo = "sad"

let story = "Today was a big day for \(name). They had finally saved up \(number) dollars and were going to buy a \(adjective) \(noun). They went to the \(noun) \(place) feeling very \(positiveEmo). But then they felt \(negativeEmo). They were all out of \(noun)!"
